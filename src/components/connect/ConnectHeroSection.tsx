...
export function ConnectHeroSection({ onScrollToForm }: ConnectHeroSectionProps) {
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.85)), url('https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=1920&q=80')`,
