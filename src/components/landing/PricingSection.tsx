...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: "Módulo ENTENDER MEU NEGÓCIO", included: true },
      { text: "DRE Inteligente", included: true, isSubItem: true },
      { text: "Score Tributário", included: true, isSubItem: true },
      { text: "Comparativo de Regimes", included: true, isSubItem: true },
      { text: "Simpronto 2027", included: true, isSubItem: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "TribuTalks Connect", included: true },
      { text: "Compra de créditos Clara", included: true },
    ],
    ctaText: "Testar 7 dias grátis",
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Módulo PRECIFICAÇÃO", included: true },
      { text: "Margem Ativa (NCM)", included: true, isSubItem: true },
      { text: "Split Payment 2026", included: true, isSubItem: true },
      { text: "PriceGuard", included: true, isSubItem: true },
      { text: "OMC-AI (Fornecedores)", included: true, isSubItem: true },
      { text: "Módulo COMANDAR", included: true },
      { text: "NEXUS (Centro de Comando)", included: true, isSubItem: true },
      { text: "Valuation (3 metodologias)", included: true, isSubItem: true, limitText: "DCF, EBITDA, Receita" },
      { text: "Relatórios Executivos PDF", included: true, isSubItem: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Painel Executivo avançado", included: true },
      { text: "Consultoria Rebechi & Silva", included: true },
      { text: "Atendimento jurídico especializado", included: true },
    ],
