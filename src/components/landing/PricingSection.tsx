...
const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Diagnóstico Tributário Completo (XMLs ilimitados)", included: true },
      { text: "Preparação para a Reforma (dados reais)", included: true },
      { text: "Análise de Contratos Societários (IA)", included: true },
      { text: "Simulação de Preços (margem real)", included: true },
