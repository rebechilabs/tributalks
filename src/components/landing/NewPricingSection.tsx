      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        >
          ...
          <p className="text-lg text-white/60">
            Valores sob consulta. Fale com nosso time comercial.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-8">
          {plans.map((plan, index) => (
            ...
            >
              ...
              {/* CTA */}
              <a href={CONFIG.WHATSAPP} target="_blank" rel="noopener noreferrer" className="block mt-auto">
                <Button
        ...
        <p className="text-center text-sm text-white/40 mb-10">
          Entre em contato para conhecer condições especiais.
        </p>
